                ...
                !win ?
                    (
                        <div style={{textAlign: "center"}}>
                            ...
                            <form onSubmit={handleSubmit}>
                                <TextField
                                    ...
                                    sx={{maxWidth: 250, margin: "auto", display: "block"}}
                                />
                                <Button
                                    variant="contained"
                                    sx={{margin: 10}}
                            ...
                            </form>
                            {
                                correct ? (
                                    <div>
                                        ...
                                        <Button variant="contained" onClick={nextClickedHandler} >Next!</Button>
                                    </div>
                                ) : null
                            }
                            {
                        ...
                        <div style={{textAlign: "center"}}>
                            ...
                            <Button onClick={playAgainHandler} variant="contained">Play again?</Button>
                        </div>)
            }
